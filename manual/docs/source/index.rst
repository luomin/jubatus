...
Jubatusの名前の由来は、俊敏な動物であるチータの学術名からの命名で、「ユバタス」と読みます。株式会社Preferred InfrastructureとNTTソフトウェアイノベーションセンタの共同開発した、日本初となるビッグデータオープンソースプロダクトです。
...
.. toctree::
   ...
   doc/01_00_Summary
   doc/02_00_For_System_Provider
   doc/03_00_For_Application_Developer
   doc/04_00_QandA
